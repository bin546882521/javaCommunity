...
import life.chen.community.community.mapper.*;
import life.chen.community.community.model.*;
...
public class CommentService {
    ...
    public List<CommentDTO> listByTargetId(Long id, CommentTypeEnum type) {
        ...
        //where parentId = id and TYpe = getType()
        //ctrl+alt+p
        commentExample.createCriteria().andParentIdEqualTo(id).andTypeEqualTo(type.getType());
        //setOrderByClause指定排序规则，ASC升序，DESC降序，多个条件用逗号分隔
